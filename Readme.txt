...
If you don't have MATLAB license but still want to try the E-Toothbrush model, you can download this one. Following all instructions in video 1 - Setup except the part related to MATLAB. All the functions in video 2 - Model Generation work well in this model. However, functions related to MATLAB in video 3 - Automatic Design are deleted, such as motor selection based on AHP and final performance simulation. 
